...
int GzipCompressHelper(Bytef* dest,
                       ...
                       void (*free_fn)(void*)) {
  return CompressHelper(ZLIB, dest, dest_length, source, source_length,
...
int CompressHelper(WrapperType wrapper_type,
  ...
  if (malloc_fn) {
    ...
    auto zalloc = [](void* opaque, size_t items, size_t size) {
...
int GzipUncompressHelper(Bytef* dest,
                         ...
                         const Bytef* source,
                         uLong source_length) {
  return UncompressHelper(ZLIB, dest, dest_length, source, source_length);
}
